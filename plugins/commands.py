...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_req_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**🐢 Yᴏᴜ ᴀʀᴇ ɴᴏᴛ ɪɴ ᴏᴜʀ Bᴀᴄᴋ-ᴜᴘ ᴄʜᴀɴɴᴇʟ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ sᴏ ʏᴏᴜ ᴅᴏɴ'ᴛ ɢᴇᴛ ᴛʜᴇ SERIAL ғɪʟᴇ...\n \n നിങ്ങൾക്ക് സീരിയൽ ലഭിക്കണമെങ്കിൽ താഴെ കാണുന്ന     👉'📢 REQUEST TO JOIN CHANNEL 📢' ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴀɴᴅ '⤬ JOIN  HERE  AND  TRY AGAIN ⤬'   👈   ബട്ടണിൽ ക്ലിക്ക് ചെയ്ത് ജോയിൻ ചെയ്തശേഷo    '🔃 TRY AGAIN 🔃'   എന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക. \nമുക്കളിൽ പറഞ്ഞ പോലെ ചെയ്താൽ സീരിയൽ ലഭിക്കുന്നതാണ്....**",
            reply_markup=InlineKeyboardMarkup(btn),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton('𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥', url=f'https://t.me/Mallu_adminbot')
                            ]
                        ]
                    )
                )
...
InlineKeyboardButton("Hᴏᴡ Tᴏ Vᴇʀɪғʏ", url='https://t.me/Asianet_serial_HPM/332')
                ]]
                await message.reply_text(
